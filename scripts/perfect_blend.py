...
svg_code = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="140 280 360 440" width="360" height="440">
  ...
  <!-- 3. ARROW HEAD -->
  <polygon points="468,288 368,328 385,345 425,385 465,365" fill="url(#arrowGrad)" />

  <!-- 4. LOWER RIBBON ARM (Straight parallel band with smooth rounded cap) -->
  <path d="M 295,505 
           L 435,608 
           A 32.5,32.5 0 0,1 390,652 
           L 250,550 
           Z" 
