...
# Fully calibrated mathematical SVG model
svg_code = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="140 280 360 440" width="360" height="440">
  ...
  <!-- Stem: X from 200 to 265, Top cap: Center (232.5, 326.5), R=32.5
       Ring: Center (231.5, 636), Outer R=76.5, Inner Hole R=31.0
  -->
  <path d="M 200,326.5 
  ...
  <!-- 2. ARROW SHAFT (Continuous ribbon rising at 45 deg) -->
  ...
  <!-- 4. LOWER RIBBON ARM (Descending parallel band with perfect rounded cap at X=472, Y=610) -->
  <!-- Top line: (295, 505) to (435, 608)
       End cap: smooth arc through (472, 610) down to (395, 650)
       Bottom line: (395, 650) to (255, 555)
  -->
  <path d="M 295,505 
           L 435,608 
           A 34,34 0 0,1 465,622 
           A 34,34 0 0,1 395,650 
           L 255,555 
           Z" 
