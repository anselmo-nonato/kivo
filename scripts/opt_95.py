...
svg_code = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="140 280 360 440" width="360" height="440">
  ...
  <!-- 3. ARROW HEAD (Perfect match to original outline) -->
  <polygon points="468,288 375,318 385,345 430,390 468,362" fill="url(#arrowGrad)" />

  <!-- 4. LOWER RIBBON ARM (Exact slope and smooth rounded cap) -->
  <path d="M 295,435 
           L 438,572 
           A 34,34 0 0,1 468,605 
           A 34,34 0 0,1 392,642 
           L 255,510 
           Z" 
