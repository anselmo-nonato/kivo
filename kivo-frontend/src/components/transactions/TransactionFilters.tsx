...
export function TransactionFilters({
  ...
  return (
    <div className="p-2.5 sm:p-3 rounded-2xl bg-white border border-slate-200 shadow-xs flex flex-wrap items-center gap-2">
      {/* Barra de Pesquisa */}
      <div className="relative flex-1 min-w-[200px]">
        ...
        <input
          ...
          placeholder="Buscar descrição, conta ou notas..."
          className="w-full pl-8 pr-3 py-1.5 rounded-xl border border-slate-200 text-xs focus:ring-2 focus:ring-emerald-500 font-medium"
        />
      </div>
      ...
      >
        ...
        <span>{showNotes ? "Notas Visíveis" : "Notas"}</span>
      </button>
    </div>
  );
}
